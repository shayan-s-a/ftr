vlocity.cardframework.registerModule.controller('vltStepController', ['$scope','$rootScope', 'bpService', '$timeout', function ($scope, $rootScope, bpService, $timeout) {
        ...
        if (step.name == 'SelectServiceLocation') {
            ...
            if (getElementValue('SelectServiceLocation:SelectNewOrEixstingDID') == 'Existing') {
                if (!getElementValue('SelectedDIDLocation')) {
                    $scope.modal.msgs.push('A DID Location is required.');
                }

            } else if (getElementValue('SelectServiceLocation:SelectNewOrEixstingDID') == 'New') {
                if (!getElementValue(bpPaths.numberOfDIDLocations)) {
                    $scope.modal.msgs.push('The number of DID locations is required.');
                }
            }
            ...
            if (getElementValue('SelectServiceLocation.userCanEdit') == true) {
                ...
                if (getElementValue('DIDLocationDetails:DIDLocationName') == null || getElementValue('DIDLocationDetails:DIDLocationName') == '') {
                ...
                if (getElementValue('DIDLocationDetails:DIDTestNumber') != null  && getElementValue('DIDNumbers') != '') {
            ...
            if (getElementValue('SelectServiceLocation.userCanEdit') == true) {
                ...
                if (getElementValue('Configure911:x911Option') == 'Main Designated #') {
                    ...
                    if (!getElementValue('Configure911:MainDesignatedSection:MainDesignatedNumber')) {
