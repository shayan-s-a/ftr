vlocity.cardframework.registerModule.controller("vlcCartCustomController", function ($scope, $rootScope, $window, $sldsModal, $timeout, $compile, $templateCache, bpService) {
    ...
    $scope.addProductFromCart = function (parent, obj, gParent) {
        ...
        */
        ...
        inputParam.items[0].fieldsToUpdate = {
            Term__c: $scope.bpTree.response.SelectServiceLocation.ServiceTerm
        };
